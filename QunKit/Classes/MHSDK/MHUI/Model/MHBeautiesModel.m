...
@interface MHBeautiesModel()<NSSecureCoding>
@end
...
- (void)encodeWithCoder:(NSCoder *)aCoder {
    ...
    [aCoder encodeObject:@(self.menuType) forKey:@"menuType"];
    
    [aCoder encodeObject:self.defaultValue forKey:@"oneclickDefaultValue"];
    ...
    [aCoder encodeObject:self.whiteValue forKey:@"whiteValue"];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder {
    if (self = [super init]) {
        ...
        self.menuType = (NSInteger)[aDecoder decodeObjectForKey:@"menuType"];
        self.aliment = (NSInteger)[aDecoder decodeObjectForKey:@"watermarkAliment"];
        self.isSelected = [[aDecoder decodeObjectForKey:@"isSelected"] boolValue];
        
        self.defaultValue = [aDecoder decodeObjectForKey:@"oneclickDefaultValue"];
...
+ (instancetype)mh_quickBeautyModelWithDictionary:(NSDictionary *)dic {
    ...
    model.imgName = [dic objectForKey:@"imageName"];
