...
typedef NS_ENUM(NSInteger,MHMakeupType) {
    
    MHMakeupType_NONE = 0,
    MHMakeupType_EYELASH  = 1 ,   //睫毛
    MHMakeupType_LIPSTICK  = 2  ,   //唇彩
    MHMakeupType_BLUSH   = 3 ,       //腮红
    MHMakeupType_EYELINER  = 4  ,   //眼线
    MHMakeupType_EYEBROW   = 5  ,   //眉毛
